...
return  DecoCreator:Create("deco_accademy_barrier",           "interior_wall_decals_accademia", "wall_decals_accademia", "velvetrope_backwall",   {physics="sofa_physics", tags={"furniture"}, onbuilt=true }),
        ...
        DecoCreator:Create("deco_accademy_cornerbeam",        "interior_wall_decals_accademia", "wall_decals_accademia", "pillar_square_front",   {decal=true, loopanim=true, light=DecoCreator:GetLights().SMALL, tags={"cornerpost"}, onbuilt=true}),     
        DecoCreator:Create("deco_accademy_beam",              "interior_wall_decals_accademia", "wall_decals_accademia", "pillar_square_corner",  {decal=true, loopanim=true, light=DecoCreator:GetLights().SMALL}),
