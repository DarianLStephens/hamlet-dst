...
return  DecoCreator:Create("deco_antiquities_screamcatcher",      "ceiling_decor", "ceiling_decor", "scream_catcher_idle",                            {loopanim=true}), 
        ...
        DecoCreator:Create("deco_antiquities_cornerbeam",         "interior_wall_decals_antiquities", "wall_decals_antiquities", "pillar_corner",     {decal=true, background=3, tags={"NOBLOCK","cornerpost"},name_override = "deco_wood"}),
        DecoCreator:Create("deco_antiquities_cornerbeam2",        "interior_wall_decals_antiquities", "wall_decals_antiquities", "pillar_sidewall",   {decal=true, tags={"NOBLOCK","cornerpost"}, name_override = "deco_wood"}),
        ...
        DecoCreator:Create("deco_antiquities_walllight",          "interior_wall_decals_antiquities", "wall_decals_antiquities", "sconce_sidewall1",  {decal=true, light=DecoCreator:GetLights().SMALL, tags={"NOBLOCK"}})