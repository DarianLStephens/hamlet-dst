...
local assets =
{
    ...
    Asset("MINIMAP_IMAGE", "ant_queen_entrance"),
    Asset("MINIMAP_IMAGE", "pig_ruins_exit_int"),
    Asset("MINIMAP_IMAGE", "pig_ruins_door_int"),
    Asset("MINIMAP_IMAGE", "pig_ruins_side_door_int"),
    Asset("MINIMAP_IMAGE", "pig_ruins_side_door_int_2"),
    Asset("MINIMAP_IMAGE", "vamp_bat_cave_exit"),
    Asset("MINIMAP_IMAGE", "player_frontdoor"), 
...
local function InitInteriorPrefab(inst, doer, prefab_definition, interior_definition)
	print("prop_door - Interior prefab initializing, we are inside a building")
	...
	print("Door definition data:")
	print("Interior name: ", door_definition.my_interior_name)
	print("Door ID: ", door_definition.my_door_id)
	print("Target Door ID: ", door_definition.target_door_id)
	print("Target Interior: ", door_definition.target_interior)
	
	print("Direct data:")
	print("Interior name: ", interior_definition.unique_name)
	print("Door ID: ", prefab_definition.my_door_id)
	print("Target Door ID: ", prefab_definition.target_door_id)
	print("Target Interior: ", prefab_definition.target_interior)
...
local function disableDoor(inst, setting, cause)
	...
	if interior_spawner.doors[door.target_door_id] then
		print("prop_door - Door's opposite has been visited before, according to Klei comment")
		...
		print("prop_door - Opposite door not visited, but could exist")
		...
		if interior then		
			print("prop_door - Parent interior found as ", interior)
...
local function InitInteriorPrefab_shadow(inst, doer, prefab_definition, interior_definition)
	print("prop_door's shadow - Interior prefab initializing, we are inside a building")
	--If we are spawned inside of a building, then update our door to point at our interior
