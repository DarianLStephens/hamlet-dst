...
return  DecoCreator:Create("window_round",                 "interior_window", "interior_window_side", "day_loop",          {loopanim=true, decal=true, background=3, dayevents=true,                children={"window_round_light"},          tags={"NOBLOCK","wallsection"}, onbuilt=true}), 
    ...
    --    DecoCreator:Create("window_sunlight", "interior_window_lightfx", "interior_window_lightfx", "idle_loop_xx",                     {light=true}),
        ...
        DecoCreator:Create("deco_chaise",  "interior_floor_decor",         "interior_floor_decor", "chaise",        {physics="sofa_physics", tags={"furniture"}, onbuilt=true }),
