...
local function rug_worn()
	local inst = commonfn("rug_worn")
	return inst
end	
...
return Prefab("rug_round", round, assets, prefabs),
	   Prefab("rug_oval", oval, assets, prefabs),
	   Prefab("rug_square", square, assets, prefabs),
	   Prefab("rug_rectangle", rectangle, assets, prefabs),
	   Prefab("rug_leather", leather, assets, prefabs),	   
	   Prefab("rug_fur", fur, assets, prefabs),
	   Prefab("rug_circle", circle, assets, prefabs),	   
	   Prefab("rug_hedgehog", hedgehog, assets, prefabs),
	   Prefab("rug_porcupuss", porcupus, assets, prefabs),
	   Prefab("rug_hoofprint", hoofprint, assets, prefabs),
	   Prefab("rug_octagon", octagon, assets, prefabs),
	   Prefab("rug_swirl", swirl, assets, prefabs),
	   Prefab("rug_catcoon", catcoon, assets, prefabs),
	   Prefab("rug_rubbermat", rubbermat, assets, prefabs),
	   Prefab("rug_web", web, assets, prefabs),
	   Prefab("rug_metal", metal, assets, prefabs),
	   Prefab("rug_wormhole", wormhole, assets, prefabs),
	   Prefab("rug_braid", braid, assets, prefabs),
	   Prefab("rug_beard", beard, assets, prefabs),
	   Prefab("rug_nailbed", nailbed, assets, prefabs),
	   Prefab("rug_crime", crime, assets, prefabs),
	   Prefab("rug_tiles", tiles, assets, prefabs),
	   Prefab("rug_cityhall_corners", cityhall_corners, assets, prefabs),
	   Prefab("rug_palace_corners", palace_corners, assets, prefabs),
	   Prefab("rug_palace_runner", palace_runner, assets, prefabs),
	   Prefab("rug_worn", rug_worn, assets, prefabs)
